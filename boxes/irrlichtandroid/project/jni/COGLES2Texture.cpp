...
//! constructor for usual textures
                ...
                UseStencil( false ), ReadOnlyLock( false )
        {
            ...
            if ( Image )
            {
                ...
                __android_log_print(ANDROID_LOG_INFO, "TEXTURE", "jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj %s Texture Name %d",name.c_str(), TextureName);
                copyTexture();
            }
        }
...
//! destructor
        ...
        void COGLES2Texture::getImageData( IImage* image )
        {
            ...
            ImageSize = image->getDimension();
				...
				__android_log_print(ANDROID_LOG_INFO, "TEXTURE INFO", "texture width=%u height=%u",ImageSize.Width, ImageSize.Height);
