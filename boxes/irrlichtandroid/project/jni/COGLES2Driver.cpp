...
//! Draws a 2d line.
        ...
        bool COGLES2Driver::setTexture( u32 stage, const video::ITexture* texture )
        {
            ...
            if (testGLError()) {
                __android_log_print(ANDROID_LOG_INFO, "ACTIVE TEXTURE SET ERROR", "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ %d %p", stage, texture);
            }
            ...
            else
            {
                ...
                if (testGLError()) {
                    __android_log_print(ANDROID_LOG_INFO, "BIND TEXTURE SET ERROR", "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ %d %p", stage, texture);
                }
            }
...
//! creates a opengltexturematrix from a D3D style texture matrix
        ...
        void COGLES2Driver::setMaterial( const SMaterial& material )
        {
            ...
            {
                //__android_log_print(ANDROID_LOG_INFO, "DRIVER SET MATERIAL", ":::::::::::::::::::::::::::: %d %p", i, Material.getTexture( i ));
